...
## Engine 1: embedchain Lifecycle Kernel
...
## Engine 2: embedchain ReAct Loop Engine
...
export class embedchainAgentLoopEngine {
  constructor(
    private ctx: embedchainLifecycleContext,
...
## Engine 3: embedchain Unified Model Stream Adapter
...
export class embedchainModelAdapter {
  ...
  public async *generateStream(messages: any[], tools: any[]): AsyncIterable<StreamDelta> {
    try {
      ...
      yield {
        type: 'thought_chunk',
        deltaThought: `[embedchainModelAdapter] Reasoning offline: Analyzing execution invariant for ${messages.length} messages.\n`,
      };
      yield {
        type: 'text_chunk',
...
## Engine 4: embedchain Tool Sandbox & Virtual File System Engine
...
export class embedchainVirtualFileSystem {
...
export class embedchainToolSandbox {
  private vfs: embedchainVirtualFileSystem;

  constructor(initialFiles: Record<string, string> = {}) {
    this.vfs = new embedchainVirtualFileSystem(initialFiles);
  }
...
## Engine 5: embedchain Non-Linear Session Tree & Token Budget Engine
...
export class embedchainSessionTreeEngine {
