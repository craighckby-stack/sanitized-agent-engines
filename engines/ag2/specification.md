...
## Engine 2: ag2 ReAct Loop Engine
...
## Engine 3: ag2 Unified Model Stream Adapter
...
export class ag2ModelAdapter {
  ...
  public async *generateStream(messages: any[], tools: any[]): AsyncIterable<StreamDelta> {
    try {
      ...
      yield {
        type: 'thought_chunk',
        deltaThought: `[ag2ModelAdapter] Reasoning offline: Analyzing execution invariant for ${messages.length} messages.\n`,
      };
      yield {
        type: 'text_chunk',
...
## Engine 4: ag2 Tool Sandbox & Virtual File System Engine
...
export class ag2ToolSandbox {
  ...
  constructor(initialFiles: Record<string, string> = {}) {
    this.vfs = new ag2VirtualFileSystem(initialFiles);
  }
...
## Engine 5: ag2 Non-Linear Session Tree & Token Budget Engine
