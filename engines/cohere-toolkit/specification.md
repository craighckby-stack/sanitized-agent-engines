...
## Engine 1: cohere-toolkit Lifecycle Kernel
...
## Engine 2: cohere-toolkit ReAct Loop Engine
...
export class cohere-toolkitAgentLoopEngine {
  constructor(
    private ctx: cohere-toolkitLifecycleContext,
...
## Engine 3: cohere-toolkit Unified Model Stream Adapter
...
export class cohere-toolkitModelAdapter {
  ...
  public async *generateStream(messages: any[], tools: any[]): AsyncIterable<StreamDelta> {
    try {
      ...
      yield {
        type: 'thought_chunk',
        deltaThought: `[cohere-toolkitModelAdapter] Reasoning offline: Analyzing execution invariant for ${messages.length} messages.\n`,
      };
      yield {
        type: 'text_chunk',
...
## Engine 4: cohere-toolkit Tool Sandbox & Virtual File System Engine
...
export class cohere-toolkitVirtualFileSystem {
...
export class cohere-toolkitToolSandbox {
  private vfs: cohere-toolkitVirtualFileSystem;

  constructor(initialFiles: Record<string, string> = {}) {
    this.vfs = new cohere-toolkitVirtualFileSystem(initialFiles);
  }
...
## Engine 5: cohere-toolkit Non-Linear Session Tree & Token Budget Engine
...
export class cohere-toolkitSessionTreeEngine {
